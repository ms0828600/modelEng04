...
public class FormSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case FormPackage.INPUT_FIELD: {
				...
				if (result == null) result = casePageElement(inputField);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormPackage.TEXT_FIELD: {
				...
				if (result == null) result = caseInputField(textField);
			...
			case FormPackage.SELECTION_FIELD: {
				...
				if (result == null) result = caseInputField(selectionField);
			...
			case FormPackage.TEXT_AREA: {
				...
				if (result == null) result = caseInputField(textArea);
			...
			case FormPackage.HEADING: {
				...
				if (result == null) result = caseText(heading);
				if (result == null) result = casePageElement(heading);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case FormPackage.PARAGRAPH: {
				...
				if (result == null) result = casePageElement(paragraph);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			...
			case FormPackage.SELECTION_CONDITION: {
				SelectionCondition selectionCondition = (SelectionCondition)theEObject;
				T result = caseSelectionCondition(selectionCondition);
				if (result == null) result = caseVisibilityCondition(selectionCondition);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Selection Condition</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Selection Condition</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseSelectionCondition(SelectionCondition object) {
		return null;
	}
