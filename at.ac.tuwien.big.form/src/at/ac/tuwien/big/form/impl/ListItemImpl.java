 ...
 * <ul>
 *   <li>{@link at.ac.tuwien.big.form.impl.ListItemImpl#getLabel <em>Label</em>}</li>
 * </ul>
 * </p>
 *
 * @generated
...
public class ListItemImpl extends MinimalEObjectImpl.Container implements ListItem {
	...
	protected EClass eStaticClass() {
		return FormPackage.Literals.LIST_ITEM;
	}
	...
	public void setLabel(String newLabel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, FormPackage.LIST_ITEM__LABEL, oldLabel, label));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case FormPackage.LIST_ITEM__LABEL:
				return getLabel();
		}
